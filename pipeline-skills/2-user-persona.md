...
3. **Define 2-4 personas** — for each persona, include:
   ...
   - Scenario: a brief day-in-the-life narrative — reference Brandsync pattern names for any UI interactions in the scenario (e.g., "She opens the app and uses the Login pattern...")
